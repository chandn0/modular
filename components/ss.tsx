...
export const SS = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="p-4 bg-black rounded-lg shadow-md">
      <h4 className="text-lg font-bold mb-2">
        <Link href="https://www.astria.org/"  target="_blank" className="text-blue-500 hover:underline">Astria</Link>
      </h4>
    ...
    <div className="p-4 bg-black rounded-lg shadow-md">
      <h4 className="text-lg font-bold mb-2">
        <Link href="https://www.theradius.xyz/" target="_blank" className="text-blue-500 hover:underline">Radius</Link>
      </h4>
      <p className="text-white-700">
    ...
    <div className="p-4 bg-black rounded-lg shadow-md">
      <h4 className="text-lg font-bold mb-2">
        <Link href="https://www.espressosys.com/" target="_blank" className="text-blue-500 hover:underline">Espresso Systems</Link>
      </h4>
      <p className="text-white-700">
    ...
    <div className="p-4 bg-black rounded-lg shadow-md">
      <h4 className="text-lg font-bold mb-2">
        <Link href="https://www.nodekit.xyz/" target="_blank" className="text-blue-500 hover:underline">NodeKit SEQ</Link>
      </h4>
      <p className="text-white-700">
  ...
  <ul className="list-disc space-y-2 pl-4">
    <li>
      <Link href="https://maven11.substack.com/p/the-shared-sequencer" target="_blank" className="text-blue-500 hover:underline">The Shared Sequencer - Maven11 Research (substack.com)</Link>
    </li>
    <li>
      <Link href="https://docs.espressosys.com/sequencer/espresso-sequencer-architecture/readme" target="_blank" className="text-blue-500 hover:underline">Introduction - Espresso Sequencer (espressosys.com)</Link>
    </li>
    <li>
      <Link href="https://docs.theradius.xyz/overview/about-radius" target="_blank" className="text-blue-500 hover:underline">About Radius - Radius (theradius.xyz)</Link>
    </li>  <li>
      <Link href="https://nodekit.gitbook.io/nodekit-documentation" target="_blank" className="text-blue-500 hover:underline"> NodeKit Documentation</Link>
    </li>
